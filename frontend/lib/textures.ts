...
const TABLE: Array<[RegExp, TextureSet]> = [
  ...
  [/europa/, { map: "/textures/europa.jpg" }],
  [/\bio\b/, { map: "/textures/io.jpg" }],
  [/ganymede/, { map: "/textures/ganymede.jpg" }],
  [/callisto/, { map: "/textures/callisto.jpg" }],
  [/enceladus/, { map: "/textures/enceladus.jpg" }],
